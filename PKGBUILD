...
export MAKEFLAGS="LLVM=1 -j16 СС=clang"

pkgbase=linux-hardened
pkgver=5.15.2.hardened1
pkgrel=1
...
source=(
  ...
  new-config         # the main kernel config file
)
validpgpkeys=(
...
sha256sums=('5634033a4981be42d3259f50d5371a2cdc9ace5d9860da67a2879630533ab175'
            'SKIP'
            '2c0d385ceb9d84ad618fc16e0c425e4598b1a8739879b85d87416646dddc2797'
            'SKIP'
            'SKIP')
...
prepare() {
  ...
  for src in "${source[@]}"; do
    ...
    if patch -Np1 < "../$src"; then
      ...
      echo "Patching failed. Patch may be already applied."
    fi
  done
